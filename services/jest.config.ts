...
export default {
	...
	// cacheDirectory: "C:\\Users\\mad_b\\AppData\\Local\\Temp\\jest",
	...
	// An array of regexp patterns that
	// are matched against all source file paths before re-running tests in watch mode
